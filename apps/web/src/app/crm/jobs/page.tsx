  ...
  return (
    <AppShell>
      <div className="space-y-6">
        <SectionHeader
          title="Jobs"
          description="Schedule and track work against real client and site records."
          actions={
            <button
              type="button"
            ...
            {mode === "create" || mode === "edit" ? (
              ...
              <div className="space-y-6">
                ...
                <DriveFilePanel
                  ...
                  driveFolderUrl={
                    selectedJob.drive_folder_url
                    ?? sites.find((site) => site.id === selectedJob.site_id)?.drive_folder_url
                    ?? null
                  }
