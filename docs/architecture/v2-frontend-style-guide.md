...
- Navigation is limited to Clients, Sites, and Jobs.
...
Every visible normal-user action must do real work. Do not render placeholder controls for Export CSV, New Service Job, Emergency Service, API connected, notifications, profile, maps, Drive upload, Drive sync, folder scan, reports, photosheets, invoices, or quotes.
